...
self.addEventListener('fetch', function(event) {
  if (event.request.method === 'GET') {
    ...
    var navigateFallback = 'https://esstudio.site/newsfeeder/index.html';
    if (!shouldRespond &&
        navigateFallback &&
